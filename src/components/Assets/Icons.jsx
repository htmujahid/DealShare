export function Logo() {
  return <img src="/assets/icons/logo.svg" alt="" />;
}
      ...
      <g id="Iconly/Light/3 User">
        <g id="3 User">
          ...
          <path
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            d="M11.8864 11.888C13.9954 11.888 15.7054 10.179 15.7054 8.069C15.7054 5.96 13.9954 4.25 11.8864 4.25C9.77741 4.25 8.06741 5.96 8.06741 8.069C8.05941 10.171 9.75641 11.881 11.8584 11.888H11.8864Z"
            stroke="#130F26"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    >
      <g id="Iconly/Light/Activity">
        <g id="Activity">
          <path
            id="Path_33966"
            d="M7.24512 14.781L10.2383 10.8909L13.6524 13.5728L16.5815 9.79248"
            stroke="#130F26"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
