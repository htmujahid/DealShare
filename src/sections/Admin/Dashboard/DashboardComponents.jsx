    ...
    <>
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
          <ul class="space-y-2">
            <li>
              <a
                href="#"
                class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg bg-primary"
              >
                <svg
                  width="24"
                  height="24"
          ...
          <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 ">
            <li>
              <a
                href="#"
                class="flex items-center p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 "
              >
                <svg
                  width="24"
                  height="24"
                ...
                <span class="ml-4">Customer Support</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div class="p-4 m-12 sm:ml-64">
        <div className="px-4 pt-6">
            ...
            <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm ">
              <div className="w-full">
                ...
                <div className="flex items-center mb-2">
                  <div className="w-16 text-sm font-medium ">TV</div>
                ...
                <div className="flex items-center mb-2">
                  <div className="w-16 text-sm font-medium ">Watch</div>
                  <div className="w-full bg-gray-200 rounded-full h-2.5 ">
                    <div
                      className="bg-primary-600 h-2.5 rounded-full "
                      style={{ width: "15%" }}
                ...
                <div className="flex items-center mb-2">
                  <div className="w-16 text-sm font-medium ">PC</div>
                  <div className="w-full bg-gray-200 rounded-full h-2.5 ">
                    <div
                      className="bg-primary-600 h-2.5 rounded-full "
                      style={{ width: "60%" }}
                ...
                <div className="flex items-center mb-2">
                  <div className="w-16 text-sm font-medium ">Mobile</div>
                  <div className="w-full bg-gray-200 rounded-full h-2.5 ">
                    <div
                      className="bg-primary-600 h-2.5 rounded-full "
                      style={{ width: "30%" }}
          ...
          <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm mt-12">
            ...
            <div className="flex items-center justify-between pt-3 sm:pt-6">
              <div>
                <button
                  ...
                  type="button"
                  data-dropdown-toggle="orders-dropdown"
                >
                  Last 7 days
                  <svg
                    className="w-4 h-4 ml-2"
