...
export const getEstimatedTimeOfArrival = async (
  ...
  const quantityPercentage = product.quantity / product.poolThreshold;
  ...
  */
  if (address.stateCountry !== manufacturer.stateCountry) {
    estimatedTime += 10 * 24;
  } else {
    console.log(
      "Customer",
    ...
    console.log(
      "Hours",
      getHoursCaclculatedForDistance(distance, baseDistance)
    );
